...
| [deepagents-filesystem.md](deepagents-filesystem.md) | 虚拟文件系统、后端选择、文件操作工具 | 需要文件读写能力时 |
...
| [deepagents-middleware.md](deepagents-middleware.md) | 中间件、Human-in-the-loop、其他扩展点 | 扩展 Agent 行为时 |
